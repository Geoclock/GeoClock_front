  ...
  async function signInWithGoogleAsync() {
    try {
      const result = await Google1.logInAsync({
        iosClientId:
          "744227890838-i11eoaf4crfiet6vckhfef1ubuhdhula.apps.googleusercontent.com",
        androidClientId:
          "744227890838-labivtsmrsmb7likdrbpde1ug4mg6mb2.apps.googleusercontent.com",
      ...
      if (result.type === "success") {
        ...
        Http.post("/GoogleLogin", data1).then(function (response) {
          const resp = {};
          resp["status"] = response.data["status"];
          resp["message"] = response.data["message"];
          const user_id = response.data["id"];
    ...
    <View style={styles.container}>
      ...
      <View>
        ...
        <View>
          ...
          >
            <Text style={styles.boldsmalltext1}>
              Sign in with
              <Google />
            </Text>
          </TouchableOpacity>
